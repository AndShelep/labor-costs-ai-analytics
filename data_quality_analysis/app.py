...
ARTIFACTS_DIR = Path(os.getenv("ARTIFACTS_DIR", BASE_DIR / "artifacts" / "data_quality_analysis"))

CLEANED_CSV_PATH = PROCESSED_DIR / "costs-clean.csv"
REPORT_PATH = ARTIFACTS_DIR / "quality_report.txt"
